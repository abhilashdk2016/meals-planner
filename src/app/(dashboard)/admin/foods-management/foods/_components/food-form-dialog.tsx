...
import { useFood } from "@/app/(dashboard)/admin/foods-management/foods/_services/useFoodQueries";
import { useCategories } from "@/app/(dashboard)/admin/foods-management/categories/_services/use-category-queries";
import { useCreateFood, useUpdateFood } from "@/app/(dashboard)/admin/foods-management/foods/_services/useFoodMutations";
import { useFoodsStore } from "@/app/(dashboard)/admin/foods-management/foods/_libs/useFoodStore";
...
const FoodFormDialog = () => {
    ...
    }, [selectedFoodId, foodQuery.data, form]);
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle className="text-2xl">
                        { selectedFoodId ? 'Edit Food' : 'Create New Food' }
                    </DialogTitle>
                </DialogHeader>
